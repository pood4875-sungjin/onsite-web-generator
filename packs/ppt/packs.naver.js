...
(function () {
  ...
  function cjkHead(slides, clang) {
    ...
    return '<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>' +
      ...
      '<style>body,.slide,.slide *{font-family:"' + fam + '","Pretendard Variable",Pretendard,-apple-system,sans-serif}.bd-it,.cv-sub,.cv-team,.dv-itext,.dv-note,.dv-text,.hl-text,.hlx-fn,.ln-text,.md-cap,.nl-text,.nv-body,.nv-ctext,.nv-rtext,.ps-cap,.ps-head,.ps-text,.st-ctx,.st-sub,.tb-row,.tc-desc{font-weight:400}</style>';   /* 한자·가나는 300이 실낱 — 라이트 계열만 400으로 */
  }
