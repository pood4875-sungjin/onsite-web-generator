...
(function () {
  ...
  var CSS = [
    ...
    '.nx-runl{font-size:11px;font-weight:800;letter-spacing:.2em;color:' + GREEN + ';text-transform:uppercase}',
    '.nx-runr{font-size:11px;letter-spacing:.14em;color:#9AA0A6}',
    ...
    /* 타이틀·서브·풋라인 */
    '.nx-hl{font-size:40px;line-height:1.32;font-weight:300;letter-spacing:-.015em;margin-top:26px}.nx-hl.big{font-size:46px}',
    '.nx-sub{font-size:14px;color:#6D6F74;margin-top:12px;font-weight:400}',
    ...
    '.nx-foot .nx-ftx{font-size:15.5px;font-weight:400;color:#33363B}.nx-foot .nx-ftx b{color:' + GREEN + ';font-weight:800}',
    '.nx-foot .nx-ftr{font-size:11.5px;color:#9AA0A6;white-space:nowrap}',
    ...
    '.nx-dktitle{font-size:44px;font-weight:300;letter-spacing:-.01em;line-height:1.25;margin-top:30px;color:#575C64}.nx-dktitle b{color:#fff}',
    '.nx-dksub{font-size:13.5px;color:#8B9097;margin-top:12px}.nx-dksub b{color:' + GREEN + ';font-weight:700}',
    /* 표지·엔딩 */
    ...
    '.nx-cvtitle{font-size:74px;line-height:1.13;font-weight:300;letter-spacing:-.02em;color:#E7E9EC}.nx-cvtitle b{font-weight:800;color:#fff}.nx-cvtitle .mut{color:rgba(231,233,236,.34);font-weight:300}',
    '.nx-cvlead{display:flex;align-items:center;gap:22px;margin-top:34px}.nx-cvlead span{font-size:13.5px;letter-spacing:.06em;color:#C9CDD2}.nx-cvlead b{color:#fff;font-weight:700}',
    '.nx-cvfoot{display:flex;justify-content:space-between;font-size:11px;letter-spacing:.22em;color:#8B9097;text-transform:uppercase}',
    '.nx-cltitle{font-size:52px;line-height:1.3;font-weight:300;color:rgba(231,233,236,.42)}.nx-cltitle b{font-weight:800;color:#fff}',
    ...
    '.nx-clfoot .l{font-size:16px;color:#E7E9EC}.nx-clfoot .l b{color:' + GREEN + ';font-weight:800}',
    '.nx-clfoot .r{font-size:11.5px;line-height:1.7;color:#8B9097;text-align:right;white-space:pre-line}',
    /* 그린 지면(선언·데모) */
    '.slide.st,.slide.dm{background:' + GREEN + ';color:#fff}',
    '.nx-sttitle{font-size:66px;line-height:1.16;font-weight:300;letter-spacing:-.02em}.nx-sttitle b{font-weight:800}',
    '.nx-stcols{display:grid;grid-template-columns:1fr 1fr;gap:64px;margin-top:44px;max-width:900px}',
    '.nx-stcol{display:flex;flex-direction:column}.nx-stcol .tg{font-size:10.5px;letter-spacing:.2em;font-weight:700;color:rgba(255,255,255,.82);text-transform:uppercase}',
    '.nx-stcol .ln{height:1px;background:rgba(255,255,255,.75);margin:9px 0 12px}',
    '.nx-stcol .tx{font-size:17px;font-weight:400}.nx-stcol .tx b{font-weight:800}',
    /* 목차 */
    '.nx-tctitle{font-size:46px;font-weight:800;margin-top:26px}',
    ...
    '.nx-tocrow .no{font-size:12px;font-weight:800;color:' + GREEN + ';letter-spacing:.1em}',
    '.nx-tocrow .ch{font-size:11.5px;font-weight:800;letter-spacing:.18em;color:#8B9097;text-transform:uppercase}.nx-tocrow .ch.on{color:' + GREEN + '}',
    '.nx-tocrow .ds{font-size:17.5px;font-weight:300;color:#E7E9EC}.nx-tocrow .ds b{font-weight:800;color:#fff}',
    '.nx-tocrow .pg{font-size:11.5px;color:#6D6F74;letter-spacing:.1em}',
    /* 2열 리스트 */
    '.nx-2grid{display:grid;grid-template-columns:1fr 1fr;gap:76px;margin-top:36px}',
    '.nx-2col .hd{display:block;font-size:11px;letter-spacing:.22em;font-weight:700;color:#6D6F74;border-bottom:1.5px solid #14181F;padding-bottom:10px}',
    ...
    '.nx-2col li i{font-style:normal;font-size:10.5px;font-weight:700;letter-spacing:.08em;color:#9AA0A6;flex:0 0 auto}',
    '.nx-2col.grn li i{color:' + GREEN + '}',
    '.nx-2col.num li span{font-size:20px;font-weight:400}',
    '.nx-2col.dash li span{font-size:14.5px;color:#33363B}',
    '.nx-2col.dim li span{font-size:15px;color:#9AA0A6}',
    '.nx-2col.bold li span{font-size:15px;font-weight:700;color:#14181F}',
    ...
    '.nx-qlist .hd{display:block;font-size:10.5px;letter-spacing:.2em;font-weight:700;color:#6D6F74;margin-bottom:4px}',
    '.nx-qlist ul{list-style:none}.nx-qlist li{font-size:14.5px;color:#33363B;border-bottom:1px solid #E4E6E8;padding:12.5px 2px}',
    '.nx-qbar{width:4px;background:' + GREEN + ';height:100%;min-height:190px;margin-top:14px}',
    '.nx-qtx{font-size:29px;line-height:1.5;font-weight:300;margin-top:8px}.nx-qtx b{color:' + GREEN + ';font-weight:800}',
    /* 레퍼런스 카드 */
    ...
    '.nx-ref .tt{display:block;font-size:24px;margin-top:20px;letter-spacing:-.01em}',
    '.nx-ref .cp{display:block;font-size:10.5px;font-weight:800;letter-spacing:.16em;color:' + GREEN + ';margin-top:10px;text-transform:uppercase}',
    '.nx-ref .ds{font-size:13.5px;line-height:1.75;color:#4E5157;margin-top:13px}',
    '.nx-src{margin-top:auto;font-size:10.5px;line-height:1.7;color:#9AA0A6}',
    /* 라인 카드 + 밴드 */
    ...
    '.nx-lc .cp{display:block;font-size:10.5px;font-weight:700;letter-spacing:.16em;color:#6D6F74;margin-top:14px;text-transform:uppercase}',
    '.nx-lc .tt{display:block;font-size:19px;margin-top:7px;line-height:1.35}',
    '.nx-lc .ds{font-size:13px;line-height:1.7;color:#4E5157;margin-top:9px}',
    '.nx-band{margin-top:36px;background:#EBFBEE;padding:17px 26px;display:flex;align-items:baseline;gap:22px}',
    '.nx-band .bt{font-size:10.5px;font-weight:800;letter-spacing:.14em;color:' + GREEN + ';white-space:nowrap}',
    '.nx-band .bx{font-size:15px;color:#14181F}.nx-band .bx b{font-weight:800}',
    ''
  ].join('\n');
  ...
  CSS += [
    ...
    '.nx-bn .no{font-size:46px;font-weight:200;color:' + GREEN + ';letter-spacing:-.02em}',
    '.nx-bn .ln{display:block;height:1.5px;background:#14181F;margin:16px 0 14px}',
    '.nx-bn .tt{display:block;font-size:17.5px}',
    '.nx-bn .ds{font-size:13px;line-height:1.7;color:#6D6F74;margin-top:8px}',
    /* 어젠다 상태 카드 */
    ...
    '.nx-ag .cp{display:block;font-size:10px;font-weight:700;letter-spacing:.16em;color:#9AA0A6;margin-top:13px;text-transform:uppercase}',
    '.nx-ag .tt{display:block;font-size:20px;margin-top:7px;line-height:1.3;font-weight:800;color:#14181F}',
    '.nx-ag:not(.on) .tt{font-weight:400;color:#33363B}',
    '.nx-ag .stt{display:block;font-size:11px;font-weight:700;color:' + GREEN + ';margin-top:9px}',
    '.nx-ag:not(.on) .stt{color:#9AA0A6;font-weight:400}',
    '.nx-ag .ds{font-size:12.5px;line-height:1.65;color:#4E5157;margin-top:8px}',
    /* 프로세스 */
    '.nx-prlab{display:flex;align-items:center;gap:16px;margin-top:40px}',
    '.nx-prlab .cp{font-size:10.5px;font-weight:800;letter-spacing:.2em;color:#33363B;white-space:nowrap}',
    '.nx-prlab .ln{flex:1;height:1px;background:#C6C9CD}',
    '.nx-prlab .cr{font-size:11px;color:#9AA0A6;white-space:nowrap}',
    ...
    '.nx-pc .cp{display:block;font-size:10px;font-weight:700;letter-spacing:.16em;color:#6D6F74;text-transform:uppercase}',
    '.nx-pc .tt{display:block;font-size:26px;font-weight:300;line-height:1.3;margin-top:12px}',
    '.nx-pc .ds{font-size:12.5px;color:#6D6F74;margin-top:16px}',
    '.nx-pc.on{background:' + GREEN + ';color:#fff;border-top:none;padding:30px 28px;margin:-14px 0}',
    '.nx-pc.on .cp{color:rgba(255,255,255,.85)}',
    '.nx-pc.on .tt{font-weight:800;font-size:30px}',
    '.nx-pc.on .ds{color:#fff;font-weight:500;margin-top:20px}',
    /* 다크 히어로 */
    '.nx-dhtitle{font-size:56px;font-weight:800;letter-spacing:-.015em;margin-top:34px;color:#fff}.nx-dhtitle .mut{color:#575C64;font-weight:300}',
    ...
    '.nx-dhl .cp{display:block;font-size:10.5px;font-weight:800;letter-spacing:.2em;color:' + GREEN + ';margin-top:16px;text-transform:uppercase}',
    '.nx-dhl .ld{font-size:25px;font-weight:300;line-height:1.45;margin-top:11px;color:#E7E9EC}.nx-dhl .ld b{font-weight:800;color:#fff}',
    ...
    '.nx-dhmini .cp{display:block;font-size:9.5px;font-weight:800;letter-spacing:.16em;color:' + GREEN + ';text-transform:uppercase}',
    '.nx-dhmini .tt{display:block;font-size:16px;color:#fff;margin-top:6px}',
    '.nx-dhmini .ds{font-size:11.5px;color:#8B9097;margin-top:5px;line-height:1.6}',
    '.nx-dhr .cp{display:block;font-size:10px;font-weight:700;letter-spacing:.18em;color:#6D6F74;margin-bottom:6px;text-transform:uppercase}',
    '.nx-dhr ul{list-style:none}',
    '.nx-dhr li{font-size:13px;color:#C9CDD2;padding:7.5px 0;font-weight:300}',
    ...
    '.nx-sprow .rl{font-size:10.5px;font-weight:800;letter-spacing:.2em;color:#6D6F74;text-transform:uppercase}',
    '.nx-sprow.grn .rl{color:' + GREEN + '}',
    '.nx-sprow .tx{font-size:15px;color:#E7E9EC;font-weight:300}.nx-sprow .tx b{font-weight:800;color:#fff}',
    '.nx-sprow.on{background:' + GREEN + ';border-bottom:none;padding:22px 26px;margin:6px 0}',
    '.nx-sprow.on .rl{color:#fff}',
    '.nx-sprow.on .tx{font-size:16.5px;color:#fff;font-weight:500;line-height:1.6}.nx-sprow.on .tx b{color:#fff}',
    /* BEFORE/AFTER */
    ...
    '.nx-ba .cp{display:block;font-size:10.5px;font-weight:800;letter-spacing:.2em;color:#6D6F74;margin-top:15px;text-transform:uppercase}',
    '.nx-ba.on .cp{color:' + GREEN + '}',
    '.nx-ba ul{list-style:none;margin-top:10px}',
    '.nx-ba li{font-size:14px;color:#7A7F87;padding:8px 0;font-weight:300}',
    '.nx-ba.on li{font-size:15px;color:#fff;font-weight:500}',
    /* 데모 간지 */
    '.nx-dmtitle{font-size:72px;font-weight:300;letter-spacing:-.02em}.nx-dmtitle b{font-weight:800}',
    ...
    '.nx-dmcol .hd i{font-style:normal;font-size:10.5px;font-weight:700;letter-spacing:.12em;color:rgba(255,255,255,.8)}',
    '.nx-dmcol .hd b{font-size:19px;font-weight:800}',
    '.nx-dmcol .tx{display:block;font-size:13.5px;margin-top:12px;color:rgba(255,255,255,.95)}',
    /* 진행률 */
    '.nx-pggrid{display:grid;grid-template-columns:1fr 1.6fr;gap:80px;margin-top:44px;align-items:center}',
    '.nx-pgl .cp{display:block;font-size:10.5px;font-weight:700;letter-spacing:.22em;color:#8B9097;text-transform:uppercase}',
    '.nx-pgl .big{display:flex;align-items:baseline;margin-top:10px}',
    '.nx-pgl .big b{font-size:118px;font-weight:200;color:' + GREEN + ';letter-spacing:-.03em;line-height:1}',
    ...
    '.nx-prow .tt{font-size:15px;color:#fff;font-weight:700}',
    '.nx-prow .pc{font-size:16px;font-weight:800;color:' + GREEN + '}',
    ...
    '.nx-prow .cp{font-size:11px;color:#6D6F74;margin-top:8px}',
    '.nx-prow .cp2{font-size:11px;color:' + GREEN + ';font-weight:700;margin-top:4px}',
    '.nx-prow.on{background:#182924;border:1px solid rgba(64,192,87,.45);border-radius:4px;padding:16px 20px;margin:8px 0}',
    '.nx-prow.on .tt{font-size:16.5px}',
    /* 로드맵 */
    ...
    '.nx-rm .cp{display:block;font-size:10.5px;font-weight:800;letter-spacing:.2em;color:#9AA0A6;margin-top:14px;text-transform:uppercase}',
    '.nx-rm.now .cp{color:' + GREEN + '}.nx-rm.next .cp{color:#33363B}',
    '.nx-rm .tt{display:block;font-size:26px;font-weight:300;margin-top:5px}.nx-rm.now .tt{font-weight:800}',
    '.nx-rm ul{list-style:none;margin-top:16px}',
    '.nx-rm li{font-size:13px;color:#4E5157;padding:6.5px 0}',
    ...
    '.nx-tlc b{font-size:13px;font-weight:800;color:' + GREEN + ';white-space:nowrap}',
    '.nx-tlc span{font-size:12.5px;color:#33363B;white-space:nowrap}',
