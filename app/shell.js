...
(function () {
  ...
  var ITEMS = [['home', 'dashboard.html', '홈', ic('home', HOME)], ['projects', 'projects.html', '프로젝트', ic('folder', FOLDER)], ['resources', 'resources.html', '템플릿', ic('grid', GRID)], ['assets', 'assets.html', '자산', SHAPES], ['settings', 'settings.html', '설정', GEAR]];
